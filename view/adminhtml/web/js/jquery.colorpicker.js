...
(function( factory ) {
  ...
  var _colorpicker_index = 0,
    ...
    _container_popup = '<div class="ui-colorpicker ui-colorpicker-dialog ui-dialog ui-widget ui-widget-content ui-corner-all canvas-color" id="canvas-color" style="display: none;"></div>',
  ...
  $.widget('vanderlee.colorpicker', {
    options: {
      ...
      buttonImage:    '/pub/media/images/ui-colorpicker.png',
