	...
	public function addTextToLarge($object, $pdf) {
		...
		try {
			...
			*/
			...
			if($font_family == 'HelveticaInseratLTStd-Roman') {
				$font_family = 'helveticainseratltstd';		
			}
			
			// if($font_family == 'BrushScriptMT') {
				// $font_family = '3B03DE_0_0';		
			// }
			
			// if($font_family == 'EnglishScript') {
				// $font_family = '3B03DE_0_0';		
			// }
			
			// if($font_family == 'CopperplateGothicLTPro-32AB') {
				// $font_family = '3B03DE_1_0';		
			// }
			
			// if($font_family == 'AvantGardeGothicITCW01Md') {
				// $font_family = '3B03DE_2_0';		
			// }
			
			// if($font_family == 'dearJoeTwo') {
				// $font_family = '3B03DE_3_0';		
			// }
			
			// if($font_family == 'HelveticaLTWXX-Roman') {
				// $font_family = '3B03DE_4_0';		
			// }
			
			// if($font_family == 'HelveticaLTWXX-Bold') {
				// $font_family = '3B03DE_5_0';		
			// }
			
			// if($font_family == 'BrushScriptBTWXX-Regular') {
				// $font_family = '3B03DE_6_0';		
			// }
			
			// if($font_family == 'ITCGaramondStd-Bk') {
				// $font_family = '3B03DE_7_0';		
			// }
			
			// if($font_family == 'TimesLTPro-Roman') {
				// $font_family = '3B03DE_8_0';		
			// }
			
			// if($font_family == 'TimesLTPro-Bold') {
				// $font_family = 'timesltpro-bold';
			// }
			
			// if($font_family == 'OptimaLTStd-Medium') {
				// $font_family = '3B03DE_A_0';		
			// }
			
			// if($font_family == 'RockwellStd-Bold') {
				// $font_family = '3B03DE_B_0';		
			// }
			
			// if($font_family == 'Georgia') {
				// $font_family = '3B2715_0_0';		
			// }
			
			// if($font_family == 'Humanist521BT-Roman') {
				// $font_family = '3B2715_1_0';		
			// }
			
			// if($font_family == 'FFTransitWebProRegular') {
				// $font_family = '3B2715_2_0';		
			// }
			
			// if($font_family == 'FFTransitWebProBold') {
				// $font_family = '3B2715_3_0';		
			// }
			
			// if($font_family == 'Tahoma') {
				// $font_family = '3B2715_4_0';		
			// }
